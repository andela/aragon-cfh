...
Game.prototype.getQuestions = function getQuestions(region, cb) {
  questions.allQuestionsForGame(region.code, (data) => {
    cb(null, data);
  });
};

Game.prototype.getAnswers = function getAnswers(region, cb) {
...
Game.prototype._findPlayerIndexBySocket = function findPlayerIndexBySocket(thisPlayer) {
  let playerIndex = -1;
...
Game.prototype.setRegion = function setRegion(region) {
  this.region = region;
